# from  Scott Pakin. Regular Expressions and Gender Guessing. 
# In Computer Language Magazine, 8(12):pp. 59-68, December 1991.
# Usage: gawk -f gender.awk (then enter names, one per line)
